...
<section id="Page-banner">
	<img src="assets/images/what-we-do/short-course/Short-Course-banner.jpg" alt="Page Banner Image">
</section>
				...
				<div class="single-course">
					<div class="single-course-image">
						<a href="javascript:void(0);">
							<img src="assets/images/what-we-do/short-course/Short-Course-1.jpg" alt="Single Course Image">
						</a>
					</div>
					<p class="course-name"><a href="javascript:void(0);">Transparency for Good Governance</a></p>
				</div>
			</div>
			<div class="col-md-4">
				<div class="single-course">
					<div class="single-course-image">
						<a href="javascript:void(0);">
							<img src="assets/images/what-we-do/short-course/Short-Course-2.jpg" alt="Single Course Image">
						</a>
					</div>
					<p class="course-name"><a href="javascript:void(0);">Voice and Participation</a></p>
				</div>
			</div>
			<div class="col-md-4">
				<div class="single-course">
					<div class="single-course-image">
						<a href="javascript:void(0);">
							<img src="assets/images/what-we-do/short-course/Short-Course-3.jpg" alt="Single Course Image">
						</a>
					</div>
					<p class="course-name"><a href="javascript:void(0);">Equity for Accessing Services</a></p>
				</div>
			</div>
		</div>
	</div>
